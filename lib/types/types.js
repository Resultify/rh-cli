 ...
 * @property {GITHUB_REPO_FROM_TEMPLATE_PROMPT_DATA} [prompts.githubRepoFromTmpl] - github repo from template prompts data
 * @property {LOCAL_REPO_FROM_TEMPLATE_PROMPT_DATA} [prompts.localRepoFromTmpl] - local repo from template prompts data
 */
